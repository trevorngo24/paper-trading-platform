  ...
  return (
    <div className="bg-[#243447]/80 border border-[#81a6c6] rounded-none p-5 w-full max-w-sm
      ...
      <div className="grid grid-cols-2 gap-3">
        {updatedBadges.map((b) => (
          <div key={b.id}
               className={`flex flex-col items-center gap-1 p-3 border text-center transition-all duration-200
                           ${b.earned
                             ? "border-[#aacddc] bg-[#aacddc]/10"
                             : "border-[#81a6c6]/30 bg-[#1a2a3a]/50 opacity-40 grayscale"}`}>
            {b.icon === "star"
              ? <img src={starImg}   alt="star"   className="w-8 h-8" style={{ imageRendering: "pixelated" }} />
              : b.icon === "trophy"
              ? <img src={trophyImg} alt="trophy" className="w-8 h-8" style={{ imageRendering: "pixelated" }} />
              : b.icon === "book"
              ? <img src={bookImg}   alt="book"   className="w-8 h-8" style={{ imageRendering: "pixelated" }} />
